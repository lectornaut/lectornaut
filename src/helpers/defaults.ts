...
export const sizes = [
  {
    id: "xs",
    name: "Extra small",
    icon: IconALargeSmall,
    style: "text-xs",
  },
  { id: "sm", name: "Small", icon: IconALargeSmall, style: "text-sm" },
  {
    id: "base",
    name: "Normal",
    icon: IconALargeSmall,
  ...
  { id: "lg", name: "Large", icon: IconALargeSmall, style: "text-lg" },
  {
    id: "xl",
    name: "Extra large",
    icon: IconALargeSmall,
...
export const defaultSettingsTabs = [
  {
    ...
    links: [
      ...
      {
        name: "settings.titles.privacy",
        icon: IconShieldCheck,
        id: "privacy",
        description: "settings.descriptions.privacy",
      },
      {
