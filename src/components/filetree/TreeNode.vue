        ...
        <SidebarMenuItem>
          ...
          >
            ...
            <span
              ...
              class="border-input data-[state=checked]:bg-primary data-[state=checked]:border-primary relative flex aspect-square size-4 shrink-0 items-center justify-center rounded-4xl border"
            >
              <IconCircle
                v-if="isSelected"
