...
<template>
  <div
    ...
    :class="
      cn(
        'scroll-fade-y size-full min-h-0 min-w-0 scrollbar-thin scrollbar-gutter-stable overflow-y-auto overscroll-contain contain-content data-autoscrolling:scrollbar-none',
        props.class
      )
    "
