...
import { IconCirclePlus, IconTrash } from "@/data/icons"
          ...
          <FieldSet>
            <Field orientation="vertical">
              ...
              <Input
                ...
                v-model="draft.name"
                :placeholder="t('settings.agents.customTools.name.placeholder')"
          ...
          <FieldSet>
            ...
            >
              ...
              <Input
                ...
                :placeholder="
                  t('settings.agents.customTools.field.descriptionPlaceholder')
                "
                ...
                <SelectContent>
                  ...
                  >
                    <div class="flex flex-col items-start gap-0.5">
                      <span>
                        {{
                          t(`settings.agents.customTools.action.kinds.${kind}`)
                        }}
                      </span>
            ...
            <template v-if="draft.action.kind === 'httpWebhook'">
              <Field orientation="vertical">
                <FieldContent>
                  <FieldLabel>
                    {{
                      t("settings.agents.customTools.action.httpWebhook.url")
                    }}
                  </FieldLabel>
                </FieldContent>
                <Input
              ...
              <Field orientation="vertical">
                <FieldContent>
                  <FieldLabel>
                    {{
                      t("settings.agents.customTools.action.httpWebhook.method")
                    }}
                  </FieldLabel>
                </FieldContent>
                <Select v-model="draft.action.method" :disabled="!canManage">
              ...
              <Field orientation="vertical">
                ...
                >
                  <IconCirclePlus />
                  {{
                    t("settings.agents.customTools.action.httpWebhook.headers")
                  }}
                </Button>
              </Field>
