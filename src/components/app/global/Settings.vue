                      ...
                      <Collapsible>
                        <div class="grid gap-3">
                          <CollapsibleTrigger as-child>
                            <div
                              class="group bg-secondary relative rounded py-4"
                            >
                              <Badge
                                variant="secondary"
                            ...
                            <div class="overflow-clip rounded border">
                              <Table class="bg-secondary overflow-hidden">
                                ...
                                <TableFooter class="bg-secondary">
                                  <TableRow
                                    class="bg-secondary hover:bg-transparent"
                                  >
                                    <TableCell class="p-2">
                  ...
                  <FieldSet>
                    <Field orientation="vertical">
                      ...
                      <RadioGroup
                        ...
                        @update:model-value="
                          (val) =>
                            (billingCycle = val as 'annually' | 'monthly')
                        "
                      >
                        <Field orientation="horizontal">
