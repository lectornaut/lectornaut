...
import { Paintbrush, Settings } from "lucide-vue-next"
...
const data = {
  nav: [
    { name: "Account", icon: Settings, id: "account" },
...
<template>
  <Dialog v-model:open="openSettings">
    <DialogContent class="max-h-3/5 overflow-hidden p-0">
      ...
      <Tabs :default-value="defaultTab" orientation="vertical">
        <SidebarProvider>
          <Sidebar collapsible="none" class="bg-muted">
