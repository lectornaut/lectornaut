...
const applyPersistedPanelState = () => {
  syncPanelCollapsed(sidebarPanel.value, !sidebarOpen.value)
...
watch(
  [sidebarOpen, leftPanelCollapsed, rightPanelCollapsed, bottomPanelCollapsed],
  () => {
    void nextTick(() => {
      applyPersistedPanelState()
    })
                                          ...
                                          <Tooltip>
                                            ...
                                            <TooltipContent>
                                              {{
                                                topPanel?.isCollapsed
                                                  ? t(
                                                      "layouts.app.panel.minimize"
                                                    )
                                                  : t(
                                                      "layouts.app.panel.maximize"
                                                    )
                                              }}
                                            </TooltipContent>
                                          </Tooltip>
                                    ...
                                    <Empty v-if="source.length === 0">
                                      ...
                                      <EmptyContent>
                                        ...
                                        >
                                          {{
                                            t(
                                              "layouts.app.empty.console.action"
                                            )
                                          }}
                                        </Button>
                                      </EmptyContent>
                    ...
                    <ContextMenu>
                      <ContextMenuTrigger as-child>
                        ...
                        >
                          ...
                          >
                            <span
                              class="ml-2 flex items-center gap-2 font-medium"
                            >
                              <IconGripHorizontal />
