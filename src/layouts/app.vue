            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger as-child>
                  <ResizableHandle
                    class="data-[resize-handle-state=hover]:after:bg-primary data-[resize-handle-state=drag]:after:bg-primary data-[resize-handle-state=hover]:bg-primary data-[resize-handle-state=drag]:bg-primary focus-visible:ring-sidebar-accent focus-visible:bg-primary z-20 w-0! cursor-col-resize bg-transparent transition before:pointer-events-auto before:absolute before:inset-y-0 before:left-1/2 before:w-3 before:-translate-x-1/2 before:cursor-col-resize before:content-[''] focus-visible:ring-2 focus-visible:ring-offset-0 focus-visible:outline-none data-resize-handle:after:w-px"
                    :class="{
              ...
              >
                ...
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger as-child>
                      <ResizableHandle
                        class="data-[resize-handle-state=hover]:after:bg-primary data-[resize-handle-state=drag]:after:bg-primary data-[resize-handle-state=hover]:bg-primary data-[resize-handle-state=drag]:bg-primary focus-visible:ring-sidebar-accent focus-visible:bg-primary z-10 h-0! w-auto! cursor-row-resize bg-transparent transition before:pointer-events-auto before:absolute before:inset-x-0 before:top-1/2 before:h-3 before:-translate-y-1/2 before:cursor-row-resize before:content-[''] focus-visible:ring-2 focus-visible:ring-offset-0 focus-visible:outline-none data-resize-handle:after:h-px!"
                        :class="{
                          'data-resize-handle:after:bg-border':
